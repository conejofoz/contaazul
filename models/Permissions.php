...
class Permissions extends Model {
    ...
    public function add($name, $id_company) {
        $sql = $this->db->prepare("INSERT INTO permission_params(name, id_company) VALUES(:name, :id_company)");
    ...
    public function addGroup($name, $plist, $id_company) {
        ...
        $sql = $this->db->prepare("INSERT INTO permission_groups(name, id_company, params) VALUES(:name, :id_company, :params)");
        $sql->bindValue(":name", $name);
        $sql->bindValue(":id_company", $id_company);
