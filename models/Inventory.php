...
class Inventory extends Model {
    ...
    public function add($name, $price, $quant, $min_quant, $id_company, $id_user) {
        $sql = $this->db->prepare("INSERT INTO inventory( "
                . "name, price, quant, min_quant, id_company) "
                . "VALUES( "
                . ":name, :price, :quant, :min_quant, :id_company) ");
        ...
        $this->setLog($id, $id_company, $id_user, 'add');
    }

    public function getInfo($id, $id_company) {
        $array = array();
        $sql = $this->db->prepare("SELECT * FROM inventory WHERE id = :id AND "
        ...
        $sql = $this->db->prepare("UPDATE inventory SET "
                . "name = :name, price = :price, quant = :quant, min_quant = :min_quant "
    ...
    public function decrease($id_prod, $id_company, $quant_prod, $id_user){
        $sql = $this->db->prepare("UPDATE inventory SET quant = quant - $quant_prod "
                . "WHERE id = :id AND id_company = :id_company");
